...
extern "C" {
	...
	pub fn al_attach_shader_source_file(
		shader: *mut ALLEGRO_SHADER, _type: ALLEGRO_SHADER_TYPE, filename: *const c_char,
	) -> c_bool;
	...
	pub fn al_set_shader_sampler(
		name: *const c_char, bitmap: *mut ALLEGRO_BITMAP, unit: c_int,
	) -> c_bool;
	...
	pub fn al_set_shader_int_vector(
		name: *const c_char, num_components: c_int, i: *mut c_int, num_elems: c_int,
	) -> c_bool;
	pub fn al_set_shader_float_vector(
		name: *const c_char, num_components: c_int, f: *mut c_float, num_elems: c_int,
	) -> c_bool;
	pub fn al_set_shader_bool(name: *const c_char, b: c_bool) -> c_bool;
	pub fn al_get_default_shader_source(
		platform: ALLEGRO_SHADER_PLATFORM, _type: ALLEGRO_SHADER_TYPE,
	) -> *const c_char;
}
