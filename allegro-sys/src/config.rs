...
unsafe extern "C" {
	...
	pub fn al_set_config_value(
		config: *mut ALLEGRO_CONFIG, section: *const c_char, key: *const c_char,
		value: *const c_char,
	) -> ();
	pub fn al_add_config_comment(
		config: *mut ALLEGRO_CONFIG, section: *const c_char, comment: *const c_char,
	) -> ();
	pub fn al_get_config_value(
		config: *const ALLEGRO_CONFIG, section: *const c_char, key: *const c_char,
	) -> *const c_char;
	...
	pub fn al_save_config_file_f(file: *mut ALLEGRO_FILE, config: *const ALLEGRO_CONFIG) -> c_bool;
	pub fn al_merge_config_into(master: *mut ALLEGRO_CONFIG, add: *const ALLEGRO_CONFIG) -> ();
	pub fn al_merge_config(
		cfg1: *const ALLEGRO_CONFIG, cfg2: *const ALLEGRO_CONFIG,
	) -> *mut ALLEGRO_CONFIG;
	pub fn al_destroy_config(config: *mut ALLEGRO_CONFIG) -> ();
	pub fn al_remove_config_section(config: *mut ALLEGRO_CONFIG, section: *const c_char) -> c_bool;
	pub fn al_remove_config_key(
		config: *mut ALLEGRO_CONFIG, section: *const c_char, key: *const c_char,
	) -> c_bool;
	pub fn al_get_first_config_section(
		config: *const ALLEGRO_CONFIG, iterator: *mut *mut ALLEGRO_CONFIG_SECTION,
	) -> *const c_char;
	pub fn al_get_next_config_section(iterator: *mut *mut ALLEGRO_CONFIG_SECTION) -> *const c_char;
	pub fn al_get_first_config_entry(
		config: *const ALLEGRO_CONFIG, section: *const c_char,
