...
pub mod allegro_audio
{
	...
	unsafe extern "C" {
		...
		pub fn al_get_sample_instance_depth(
			spl: *const ALLEGRO_SAMPLE_INSTANCE,
		) -> ALLEGRO_AUDIO_DEPTH;
		pub fn al_get_sample_instance_channels(
			spl: *const ALLEGRO_SAMPLE_INSTANCE,
		) -> ALLEGRO_CHANNEL_CONF;
		pub fn al_get_sample_instance_playmode(
			spl: *const ALLEGRO_SAMPLE_INSTANCE,
		) -> ALLEGRO_PLAYMODE;
		...
		pub fn al_set_sample_instance_position(
			spl: *mut ALLEGRO_SAMPLE_INSTANCE, val: c_uint,
		) -> c_bool;
		pub fn al_set_sample_instance_length(
			spl: *mut ALLEGRO_SAMPLE_INSTANCE, val: c_uint,
		) -> c_bool;
		pub fn al_set_sample_instance_speed(
			spl: *mut ALLEGRO_SAMPLE_INSTANCE, val: c_float,
		) -> c_bool;
		pub fn al_set_sample_instance_gain(
			spl: *mut ALLEGRO_SAMPLE_INSTANCE, val: c_float,
		) -> c_bool;
		pub fn al_set_sample_instance_pan(
			spl: *mut ALLEGRO_SAMPLE_INSTANCE, val: c_float,
		) -> c_bool;
		pub fn al_set_sample_instance_playmode(
			spl: *mut ALLEGRO_SAMPLE_INSTANCE, val: ALLEGRO_PLAYMODE,
		) -> c_bool;
		pub fn al_set_sample_instance_playing(
			spl: *mut ALLEGRO_SAMPLE_INSTANCE, val: c_bool,
		) -> c_bool;
		pub fn al_detach_sample_instance(spl: *mut ALLEGRO_SAMPLE_INSTANCE) -> c_bool;
		pub fn al_set_sample(
			spl: *mut ALLEGRO_SAMPLE_INSTANCE, data: *mut ALLEGRO_SAMPLE,
		) -> c_bool;
		...
		pub fn al_create_audio_stream(
			buffer_count: size_t, samples: c_uint, freq: c_uint, depth: ALLEGRO_AUDIO_DEPTH,
		...
		pub fn al_get_available_audio_stream_fragments(
			stream: *const ALLEGRO_AUDIO_STREAM,
		) -> c_uint;
		...
		pub fn al_get_audio_stream_channels(
			stream: *const ALLEGRO_AUDIO_STREAM,
		) -> ALLEGRO_CHANNEL_CONF;
		pub fn al_get_audio_stream_depth(
			stream: *const ALLEGRO_AUDIO_STREAM,
		) -> ALLEGRO_AUDIO_DEPTH;
		pub fn al_get_audio_stream_playmode(
			stream: *const ALLEGRO_AUDIO_STREAM,
		) -> ALLEGRO_PLAYMODE;
		...
		pub fn al_set_audio_stream_playmode(
			stream: *mut ALLEGRO_AUDIO_STREAM, val: ALLEGRO_PLAYMODE,
		) -> c_bool;
		pub fn al_set_audio_stream_playing(
			stream: *mut ALLEGRO_AUDIO_STREAM, val: c_bool,
		) -> c_bool;
		pub fn al_detach_audio_stream(stream: *mut ALLEGRO_AUDIO_STREAM) -> c_bool;
		pub fn al_set_audio_stream_fragment(
			stream: *mut ALLEGRO_AUDIO_STREAM, val: *mut c_void,
		) -> c_bool;
		pub fn al_rewind_audio_stream(stream: *mut ALLEGRO_AUDIO_STREAM) -> c_bool;
		pub fn al_seek_audio_stream_secs(
			stream: *mut ALLEGRO_AUDIO_STREAM, time: c_double,
		) -> c_bool;
		...
		pub fn al_set_audio_stream_loop_secs(
			stream: *mut ALLEGRO_AUDIO_STREAM, start: c_double, end: c_double,
		) -> c_bool;
		pub fn al_get_audio_stream_event_source(
			stream: *mut ALLEGRO_AUDIO_STREAM,
		) -> *mut ALLEGRO_EVENT_SOURCE;

		pub fn al_create_mixer(
			freq: c_uint, depth: ALLEGRO_AUDIO_DEPTH, chan_conf: ALLEGRO_CHANNEL_CONF,
		) -> *mut ALLEGRO_MIXER;
		pub fn al_destroy_mixer(mixer: *mut ALLEGRO_MIXER);
		pub fn al_attach_sample_instance_to_mixer(
			stream: *mut ALLEGRO_SAMPLE_INSTANCE, mixer: *mut ALLEGRO_MIXER,
		) -> c_bool;
		pub fn al_attach_audio_stream_to_mixer(
			stream: *mut ALLEGRO_AUDIO_STREAM, mixer: *mut ALLEGRO_MIXER,
		) -> c_bool;
		pub fn al_attach_mixer_to_mixer(
			stream: *mut ALLEGRO_MIXER, mixer: *mut ALLEGRO_MIXER,
		) -> c_bool;
		pub fn al_set_mixer_postprocess_callback(
			mixer: *mut ALLEGRO_MIXER,
			cb: Option<extern "C" fn(arg1: *mut c_void, arg2: c_uint, arg3: *mut c_void)>,
			data: *mut c_void,
		) -> c_bool;
		...
		pub fn al_set_mixer_quality(
			mixer: *mut ALLEGRO_MIXER, val: ALLEGRO_MIXER_QUALITY,
		) -> c_bool;
		...
		pub fn al_create_voice(
			freq: c_uint, depth: ALLEGRO_AUDIO_DEPTH, chan_conf: ALLEGRO_CHANNEL_CONF,
		) -> *mut ALLEGRO_VOICE;
		pub fn al_destroy_voice(voice: *mut ALLEGRO_VOICE);
		pub fn al_attach_sample_instance_to_voice(
			stream: *mut ALLEGRO_SAMPLE_INSTANCE, voice: *mut ALLEGRO_VOICE,
		) -> c_bool;
		pub fn al_attach_audio_stream_to_voice(
			stream: *mut ALLEGRO_AUDIO_STREAM, voice: *mut ALLEGRO_VOICE,
		) -> c_bool;
		pub fn al_attach_mixer_to_voice(
			mixer: *mut ALLEGRO_MIXER, voice: *mut ALLEGRO_VOICE,
		) -> c_bool;
		...
		pub fn al_play_sample(
			data: *mut ALLEGRO_SAMPLE, gain: c_float, pan: c_float, speed: c_float,
			_loop: ALLEGRO_PLAYMODE, ret_id: *mut ALLEGRO_SAMPLE_ID,
		) -> c_bool;
		pub fn al_stop_sample(spl_id: *mut ALLEGRO_SAMPLE_ID);
		pub fn al_stop_samples();

		pub fn al_register_sample_loader(
			ext: *const c_char,
			loader: Option<extern "C" fn(arg1: *const c_char) -> *mut ALLEGRO_SAMPLE>,
		) -> c_bool;
		pub fn al_register_sample_saver(
			ext: *const c_char,
			saver: Option<extern "C" fn(arg1: *const c_char, arg2: *mut ALLEGRO_SAMPLE) -> c_bool>,
		) -> c_bool;
		pub fn al_register_audio_stream_loader(
			ext: *const c_char,
			stream_loader: Option<
				extern "C" fn(
					arg1: *const c_char,
					arg2: size_t,
					arg3: c_uint,
		...
		pub fn al_register_sample_loader_f(
			ext: *const c_char,
			loader: Option<extern "C" fn(arg1: *mut ALLEGRO_FILE) -> *mut ALLEGRO_SAMPLE>,
		) -> c_bool;
		pub fn al_register_sample_saver_f(
			ext: *const c_char,
			saver: Option<
				extern "C" fn(arg1: *mut ALLEGRO_FILE, arg2: *mut ALLEGRO_SAMPLE) -> c_bool,
			>,
		) -> c_bool;
		pub fn al_register_audio_stream_loader_f(
			ext: *const c_char,
			stream_loader: Option<
				extern "C" fn(
					arg1: *mut ALLEGRO_FILE,
					arg2: size_t,
					arg3: c_uint,
				) -> *mut ALLEGRO_AUDIO_STREAM,
			>,
		...
		pub fn al_load_audio_stream_f(
			fp: *mut ALLEGRO_FILE, ident: *const c_char, buffer_count: size_t, samples: c_uint,
		) -> *mut ALLEGRO_AUDIO_STREAM;
	}
}
