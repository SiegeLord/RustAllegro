...
macro_rules! safe_draw
(
	($b:expr) =>
	(
		unsafe
		{
			if ptr::is_null(al_get_target_bitmap())
			{
				false
			}
			else
...
impl ::internal::core::Core
{
	...
	pub fn clear_to_color(&self, color: Color) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_pixel(&self, x: f32, y: f32, color: Color) -> bool
	{
		safe_draw!
		({
	...
	pub fn put_pixel(&self, x: i32, y: i32, color: Color) -> bool
	{
		safe_draw!
		({
	...
	pub fn put_blended_pixel(&self, x: i32, y: i32, color: Color) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_bitmap<T: BitmapLike>(&self, bitmap: &T, dx: f32, dy: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_bitmap_region<T: BitmapLike>(&self, bitmap: &T, sx: f32, sy: f32, sw: f32, sh: f32, dx: f32, dy: f32, flags: BitmapDrawingFlags) -> bool
    {
        safe_draw!
		({
	...
	pub fn draw_scaled_bitmap<T: BitmapLike>(&self, bitmap: &T, sx: f32, sy: f32, sw: f32, sh: f32, dx: f32, dy: f32, dw: f32, dh: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_rotated_bitmap<T: BitmapLike>(&self, bitmap: &T, cx: f32, cy: f32, dx: f32, dy: f32, angle: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_scaled_rotated_bitmap<T: BitmapLike>(&self, bitmap: &T, cx: f32, cy: f32, dx: f32, dy: f32, xscale: f32, yscale: f32, angle: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_tinted_bitmap<T: BitmapLike>(&self, bitmap: &T, tint: Color, dx: f32, dy: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_tinted_bitmap_region<T: BitmapLike>(&self, bitmap: &T, tint: Color, sx: f32, sy: f32, sw: f32, sh: f32, dx: f32, dy: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_tinted_scaled_bitmap<T: BitmapLike>(&self, bitmap: &T, tint: Color, sx: f32, sy: f32, sw: f32, sh: f32, dx: f32, dy: f32, dw: f32, dh: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_tinted_rotated_bitmap<T: BitmapLike>(&self, bitmap: &T, tint: Color, cx: f32, cy: f32, dx: f32, dy: f32, angle: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_tinted_scaled_rotated_bitmap<T: BitmapLike>(&self, bitmap: &T, tint: Color, cx: f32, cy: f32, dx: f32, dy: f32, xscale: f32, yscale: f32, angle: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn draw_tinted_scaled_rotated_bitmap_region<T: BitmapLike>(&self, bitmap: &T, sx: f32, sy: f32, sw: f32, sh: f32, tint: Color, cx: f32, cy: f32, dx: f32, dy: f32, xscale: f32, yscale: f32, angle: f32, flags: BitmapDrawingFlags) -> bool
	{
		safe_draw!
		({
	...
	pub fn set_clipping_rectangle(&self, x: i32, y: i32, width: i32, height: i32) -> bool
	{
		safe_draw!
		({
	...
	pub fn reset_clipping_rectangle(&self) -> bool
	{
		safe_draw!
		({
	...
	pub fn get_clipping_rectangle(&self) -> Option<(i32, i32, i32, i32)>
	{
		unsafe
		{
			if ptr::is_null(al_get_target_bitmap())
