...
extern "C"
{
    ...
    pub fn al_ustr_new_from_buffer(s: *c_schar, size: c_uint) -> *mut ALLEGRO_USTR;
    ...
    pub fn al_ustr_insert_chr(us: *mut ALLEGRO_USTR, pos: c_int, c: int32_t) -> c_uint;
    ...
    pub fn al_ustr_append_chr(us: *mut ALLEGRO_USTR, c: int32_t) -> c_uint;
    ...
    pub fn al_ustr_set_chr(us: *mut ALLEGRO_USTR, pos: c_int, c: int32_t) -> c_uint;
    ...
    pub fn al_utf8_width(c: int32_t) -> c_uint;
    pub fn al_utf8_encode(s: c_void, c: int32_t) -> c_uint;
    pub fn al_ustr_new_from_utf16(s: *uint16_t) -> *mut ALLEGRO_USTR;
    pub fn al_ustr_size_utf16(us: *ALLEGRO_USTR) -> c_uint;
    pub fn al_ustr_encode_utf16(us: *ALLEGRO_USTR, s: *mut uint16_t, n: c_uint) -> c_uint;
    pub fn al_utf16_width(c: c_int) -> c_uint;
    pub fn al_utf16_encode(s: c_void, c: int32_t) -> c_uint;
}
