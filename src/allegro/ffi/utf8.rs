...
extern "C"
{
    pub fn al_ustr_new(s: *c_char) -> *mut ALLEGRO_USTR;
    pub fn al_ustr_new_from_buffer(s: *c_char, size: size_t) -> *mut ALLEGRO_USTR;
    pub fn al_ustr_free(us: *mut ALLEGRO_USTR);
    pub fn al_cstr(us: *ALLEGRO_USTR) -> *c_char;
    pub fn al_ustr_to_buffer(us: *ALLEGRO_USTR, buffer: *mut c_char, size: c_int);
    pub fn al_cstr_dup(us: *ALLEGRO_USTR) -> *mut c_char;
    ...
    pub fn al_ref_cstr(info: *mut ALLEGRO_USTR_INFO, s: *c_char) -> *ALLEGRO_USTR;
    pub fn al_ref_buffer(info: *mut ALLEGRO_USTR_INFO, s: *c_char, size: size_t) -> *ALLEGRO_USTR;
    ...
    pub fn al_ustr_insert_cstr(us: *mut ALLEGRO_USTR, pos: c_int, us2: *c_char) -> c_bool;
    ...
    pub fn al_ustr_append_cstr(us: *mut ALLEGRO_USTR, s: *c_char) -> c_bool;
    ...
    pub fn al_ustr_assign_cstr(us1: *mut ALLEGRO_USTR, s: *c_char) -> c_bool;
    ...
    pub fn al_ustr_find_set_cstr(us: *ALLEGRO_USTR, start_pos: c_int, accept: *c_char) -> c_int;
    pub fn al_ustr_find_cset(us: *ALLEGRO_USTR, start_pos: c_int, reject: *ALLEGRO_USTR) -> c_int;
    pub fn al_ustr_find_cset_cstr(us: *ALLEGRO_USTR, start_pos: c_int, reject: *c_char) -> c_int;
    pub fn al_ustr_find_str(haystack: *ALLEGRO_USTR, start_pos: c_int, needle: *ALLEGRO_USTR) -> c_int;
    pub fn al_ustr_find_cstr(haystack: *ALLEGRO_USTR, start_pos: c_int, needle: *c_char) -> c_int;
    pub fn al_ustr_rfind_str(haystack: *ALLEGRO_USTR, start_pos: c_int, needle: *ALLEGRO_USTR) -> c_int;
    pub fn al_ustr_rfind_cstr(haystack: *ALLEGRO_USTR, start_pos: c_int, needle: *c_char) -> c_int;
    pub fn al_ustr_find_replace(us: *mut ALLEGRO_USTR, start_pos: c_int, find: *ALLEGRO_USTR, replace: *ALLEGRO_USTR) -> c_bool;
    pub fn al_ustr_find_replace_cstr(us: *mut ALLEGRO_USTR, start_pos: c_int, find: *c_char, replace: *c_char) -> c_bool;
    ...
    pub fn al_ustr_has_prefix_cstr(u: *ALLEGRO_USTR, s: *c_char) -> c_bool;
    pub fn al_ustr_has_suffix(u: *ALLEGRO_USTR, v: *ALLEGRO_USTR) -> c_bool;
    pub fn al_ustr_has_suffix_cstr(us1: *ALLEGRO_USTR, s: *c_char) -> c_bool;
